...
//function encriptar
function encriptar (){
    //crear un valor de guardado var de la palabra txt.
    var frase = document.getElementById("word").value;
    //matriz para voces con palabras correctas. Arrays
    const mapWord = {
      a: "ai",
      e: "enter",
      i: "imes",
    ...
    var lbnew = document.getElementById('text-encript');lbnew.innerHTML=`${frase}`;
    var lbtext = document.getElementById('info'); lbtext.innerHTML = "Texto encriptado.";
